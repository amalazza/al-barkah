		    ...
		    <div class="col-md-12">
				<div class="card card-plain">
				  <div class="card-header">
					<center>
					<h3 class="card-title"> Tambahkan Berita Terkini dari Masjid Agung Al-Barkah Bekasi</h3>
					</center>
					<br></br>
				  </div>
				</div>
					 ...
					 <div class="row">
						<div class="col-md-12">
						  <div class="form-group">
							...
							<input type="text" name="judul" placeholder="Judul Berita" class="form-control"/>
						  </div>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-md-12">
						  <div class="form-group">
							...
							<textarea name="isi" class="ckeditor" id="ckedtor" placeholder="Isi Berita" class="form-control"></textarea>
						  </div>
						</div>
					 </div>
					<div class="row">
